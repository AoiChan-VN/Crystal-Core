...
public class AdvancedDamageEngine {

    public static AdvancedDamageResult calculate(
        ...
        AdvancedDamageResult result = new AdvancedDamageResult();
